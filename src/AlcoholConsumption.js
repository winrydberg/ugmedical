...
export default function AlcoholConsumption({setstep}) {
            ...
            <div className="col-md-6">
              <div className="form-group">
                <label htmlFor="choice">
                  <strong>1.</strong> Have you ever consumed any alcohol such as
                  beer, wine, spirits{" "}
                </label>
        ...
        <div className="col-md-12">
          <div className="row">
            ...
            <div className="col-md-6">
              <div className="form-group">
                <label htmlFor="choice">
                  <strong>4.</strong> During the past 12 months, how frequently
                  have you had at least one standard alcoholic drink?
                </label>
                <select onChange={handleUseDuration} className="form-control">
                  ...
                  <option value="1-3 days per month">1-3 days per month</option>
            ...
            <div className="col-md-6">
              <div className="form-group">
                <label htmlFor="choice">
                  ...
                  occasions did you have at least one standard alcoholic drink?
                </label>
                <input
        ...
        <div className="col-md-12">
          <div className="row">
            <div className="col-md-6">
              <div className="form-group">
                <label htmlFor="choice">
                  ...
                  did you have six or more standard drinks in a single drinking
                  occasion?
                </label>
                <input
            ...
            <div className="col-md-6">
              <div className="form-group">
                <label htmlFor="choice">
                  <strong>10.</strong> During each of the past 7 days, how many
                  standard drinks did you have each day?
                </label>
                <input
